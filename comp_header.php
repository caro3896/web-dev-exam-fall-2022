...
<body>
    ...
    <div id="menu" onclick="toggleMenu()">
        <nav class="left_nav">
            ...
            <div id="links">
                <a href="/" <?= $_title == 'Momondo' ? 'class="focus"' : '' ?> >
                    ...
                    <span><?= $dictionary[$lang.'_flights']?></span>
                </a>
                <a href="stays" <?= $_title == 'Stays' ? 'class="focus"' : '' ?> >
                ...
                <a href="things-to-do" <?= $_title == 'Things to do' ? 'class="focus"' : '' ?> >
                    ...
                    <span><?= $dictionary[$lang.'_things_to_do']?></span>
                </a>
                <a href="holidays" <?= $_title == 'Holidays' ? 'class="focus"' : '' ?> >
                    ...
                    <span><?= $dictionary[$lang.'_holidays']?></span>
                </a>
            </div>
            <div id="explore">
                <a href="explore" <?= $_title == 'Explore' ? 'class="focus"' : '' ?> >
                    ...
                    <span><?= $dictionary[$lang.'_explore']?></span>
                </a>
            </div>
            <div id="trips">
                <a href="trips" <?= $_title == 'Trips' ? 'class="focus"' : '' ?> >
                    ...
                    <span><?= $dictionary[$lang.'_trips']?></span>
                </a>
            </div>
        </nav>
    </div>
