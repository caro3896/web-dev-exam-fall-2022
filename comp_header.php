...
<body>
    <header>
        <div id="header_left">
            ...
            <a href=<?='/?lang='.$lang?>><div id="logo"></div></a>
            <!-- <img src="images/small-logo.png" alt=""> -->
        </div>
        <div id="header_right">
            <a href=<?='trips?lang='.$lang?>>Trips</a>
            <?php
            if ( $_SESSION) {
                echo 
                "<a 
                href='bridge-logout?lang='.$lang 
                class='special'>
    ...
    <div id="menu" onclick="toggleMenu()">
        <nav class="left_nav">
            ...
            <div id="links">
                <a href=<?='/?lang='.$lang?> <?= $_title == 'Momondo' ? 'class="focus"' : '' ?> >
                ...
                <a href=<?='stays?lang='.$lang?> <?= $_title == 'Stays' ? 'class="focus"' : '' ?> >
                ...
                <a href=<?='cars?lang='.$lang?> <?= $_title == 'Car Hire' ? 'class="focus"' : '' ?> >
                ...
                <a href=<?='things-to-do?lang='.$lang?> <?= $_title == 'Things to do' ? 'class="focus"' : '' ?> >
                ...
                <a href=<?='holidays?lang='.$lang?> <?= $_title == 'Holidays' ? 'class="focus"' : '' ?> >
            ...
            <div id="explore">
                <a href=<?='explore?lang='.$lang?> <?= $_title == 'Explore' ? 'class="focus"' : '' ?> >
            ...
            <div id="trips">
                <a href=<?='trips?lang='.$lang?> <?= $_title == 'Trips' ? 'class="focus"' : '' ?> >
