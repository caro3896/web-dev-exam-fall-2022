...
<body>
    <header>
        ...
        <div id="header_right">
            ...
            <a href="?lang=da" <?= $lang == 'da' ? 'style="display:none"' : "" ?>>🇩🇰 Dansk</a>   
            <a href="?lang=en" <?= $lang == 'en' ? 'style="display:none"' : "" ?>>🇬🇧 English</a>
        </div>     
    </header>
